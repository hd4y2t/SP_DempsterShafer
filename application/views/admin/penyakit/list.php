								...
								<tbody>
									<?php foreach ($penyakits as $penyakit) : ?>
										<tr>
											...
											<td width="150">
												<img src="<?= base_url('/assets/img/opt/') . $penyakit['idpenyakit'] ?>.png" class="rounded" style="height: 150px; width:150px;">
											</td>
											<td width="250">
												<a href="<?php echo site_url('admin/penyakits/edit/' . $penyakit['id']) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
