					...
					<div class="card-body">
						<form action="<?php base_url('admin/penyakit/add') ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('namapenyakit') ? 'is-invalid' : '' ?>" type="text" name="nama" placeholder="Masukkan Nama OPT" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nonkimiawi') ? 'is-invalid' : '' ?>" type="text" name="nkimia" placeholder="Masukkan Cara Penanganan Non-Kimiawi" />
								<div class="invalid-feedback">
									<?php echo form_error('name') ?>
								</div>
							</div>
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('kimiawi') ? 'is-invalid' : '' ?>" type="text" name="kimia" placeholder="Masukkan Cara Penanganan Kimiawi" />
								<div class="invalid-feedback">
									<?php echo form_error('name') ?>
								</div>
							</div>
